...
class TestUserRegistrationForm(TestCase):
    ...
    def test_unconfirmed_password(self):
        form_passwords = UserRegistrationForm({'username': 'Tested', 'email': "tested@mail.com", 'password1': '', 'password2': 'q0w9e8r7t7' })
        self.assertFalse(form_passwords.is_valid())
        self.assertRaises(ValidationError("Please confirm your password"))
