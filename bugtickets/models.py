...
class BugTicket(models.Model):
    created_by = models.ForeignKey(User, null=True, on_delete=models.SET_NULL, related_name="user_bugs")
...
class BugUpvote(models.Model):
    bug_ticket = models.ForeignKey(BugTicket, null=True, on_delete=models.SET_NULL, related_name="bug_votes")
...
class Comment(models.Model):
    bug_ticket = models.ForeignKey(BugTicket, null=True, on_delete=models.SET_NULL, related_name="comments")
