    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bug_type', models.CharField(choices=[('Functional', 'Functional'), ('Communication', 'Communication'), ('Syntax', 'Syntax'), ('Error Notices', 'Error Notices'), ('Calculation Errors', 'Calculation Errors'), ('Flow Problems', 'Flow Problems')], default=bugtickets.models.default_bug_type, max_length=30)),
